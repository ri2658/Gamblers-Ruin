...
$$
i=1, P(E_{2})-P(E_{1}) = \frac{q}{p}(P(E_{1})-P(E_{0})) <br>
i=2, P(E_{3})-P(E_{2}) = \frac{q}{p}(P(E_{2})-P(E_{1})) = (\frac{q}{p})^2(P(E_{1})-P(E_{0})) <br>
i=3, P(E_{4})-P(E_{3}) = \frac{q}{p}(P(E_{3})-P(E_{2})) = (\frac{q}{p})^3(P(E_{1})-P(E_{0})) <br> 
...<br> 
i=N-1, P(E_{N})-P(E_{N-1}) = \frac{q}{p}(P(E_{N-1})-P(E_{N-2})) = (\frac{q}{p})^{N-1}(P(E_{1})-P(E_{0})) <br>
$$

Notice the cancellations on the left-hand side when summed. Note that we invoke the initial condition $P(E_{0})=0$ here.

$$
P(E_{N})-P(E_{1})=(P(E_{1})-0)(\frac{q}{p} + (\frac{q}{p})^2 + (\frac{q}{p})^3 + ... + (\frac{q}{p})^{N-1})<br>
P(E_{N})=P(E_{1})(1+(\frac{q}{p})^1 + (\frac{q}{p})^2 + (\frac{q}{p})^3 + ... + (\frac{q}{p})^{N-1})<br>
$$
...
$$
P(E_{1})=\frac{(1-q/p)}{1-(q/p)^N}<br>
$$

Finally, consider a sum to a specific index $i$.

$$
P(E_{i})=P(E_{1})(1+(\frac{q}{p})^1 + (\frac{q}{p})^2 + (\frac{q}{p})^3 + ... + (\frac{q}{p})^{i-1})<br>
P(E_{i})=P(E_{1})(\frac{(1-(q/p)^i)}{1-q/p}) <br>
P(E_{i})=\frac{(1-q/p)}{1-(q/p)^N}(\frac{(1-(q/p)^i)}{1-q/p}) <br>
P(E_{i})=\frac{1-(q/p)^i}{1-(q/p)^N} <br>
$$
